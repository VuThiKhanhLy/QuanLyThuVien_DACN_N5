...
<header class="bg-white shadow-sm">
    <div class="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">
        ...
        <nav class="flex items-center gap-6 text-base">
            <a href="${pageContext.request.contextPath}/home" class="text-green-600 font-semibold">Trang chủ</a>
        ...
        <nav class="space-y-2">
            ...
            <a href="${allBooksUrl}"
               class="block px-3 py-2 rounded-lg text-gray-700 hover:bg-green-100 hover:text-green-700 transition font-semibold
                    <c:if test="${paramCategory == null || paramCategory == 'all'}">bg-green-100 text-green-700</c:if>">
                Tất cả
            </a>
