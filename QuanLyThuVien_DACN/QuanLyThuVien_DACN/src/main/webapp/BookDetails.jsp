...
<header class="bg-white shadow-sm">
    <div class="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">
        ...
        <nav class="flex items-center gap-6 text-base">
            <a href="${pageContext.request.contextPath}/home" class="text-gray-600 hover:text-green-600 transition">Trang chủ</a>
            <a href="#" class="text-gray-600 hover:text-green-600 transition">Hỗ trợ</a>
            <a href="Homepage.jsp" class="bg-green-600 hover:bg-green-700 text-white px-5 py-2 rounded-lg font-semibold transition">Đăng nhập</a>
        </nav>
    </div>
</header>
